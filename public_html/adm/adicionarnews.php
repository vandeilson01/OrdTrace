				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-12">
							...
							?> -->
							<form role="form" action="editaArquivoN.php" method="post" enctype="multipart/form-data">
								...
								<div class="form-group has-success">
									<input class="form-control" name="referencias" placeholder="ex: Limpeza" required="on">
								</div>
