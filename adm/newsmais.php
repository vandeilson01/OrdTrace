	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				...
				<?php
					$table = mysqli_query($con, "SELECT * FROM `news` WHERE id_news='".$_POST['id']."'");
					while($produto = mysqli_fetch_array($table)){
				?>
				<p><label>Imagem:</label> <img src="<?php echo $produto['img'];?>"></p>
				<?php
					}
				?>
			</div>
			<div class="col-md-4">
		<form role="form" action="trocarnews.php" method="post" enctype="multipart/form-data">
		<?php
			$table = mysqli_query($con, "SELECT * FROM `news` WHERE id_news='".$_POST['id']."'");
		...
		?>
								...
								<div class="form-group has-success">
									<input class="form-control" name="referencias" value="<?php echo $dad['referencias'];?>" placeholder="ex: 100,00">
								</div>
								...
								<div class="form-group">
									<label>Texto</label>
									<textarea name="texto" placeholder="Texto..." class="form-control" rows="3"><?php echo $dad['texto'];?></textarea>
								</div>
								...
								<input type="hidden" name="imagematual" required="on" value="<?php echo $dad['img'];?>">
...
?>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<h2>Alerta</h2>
				<form action="excluirnews.php" method="post">
