...
$table = mysqli_query($con, "SELECT * FROM `news` WHERE id_news='$id'");
...
$longarray = $produto['id_news'];
		...
		if($longarray == $id){
		$insert = mysqli_query($con, "UPDATE `news` SET
			titulo='$titulo',subtitulo='$subTitulo',referencias='$referencias',descricao='$descricao',texto='$texto',create_time='$create_time' WHERE id_news='$id'")or die('erro');	
