...
$longarray = $produto['id_solucoes'];
		...
		if($longarray == $id){
		$insert = mysqli_query($con, "UPDATE `solucoes` SET
			 categoria='$categoria',titulo='$titulo',subtitulo='$subTitulo',descricao='$descricao',texto='$texto',create_time='$create_time' WHERE id_solucoes='$id'")or die('erro');	
