	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				...
				<?php
					$table = mysqli_query($con, "SELECT * FROM `solucoes` WHERE id_solucoes='".$_POST['id']."'");
			...
			<div class="col-md-4">
		<form role="form" action="trocarsolucoes.php" method="post" enctype="multipart/form-data">
		<?php
			$table = mysqli_query($con, "SELECT * FROM `solucoes` WHERE id_solucoes='".$_POST['id']."'");
...
?>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<h2>Alerta</h2>
				<form action="excluirsolucoes.php" method="post">
